...
import { Download, ExternalLink, Heart, Home, Library, ListMusic, Maximize2, MoreHorizontal, Pause, Play, Plus, Search, Share2, SkipBack, SkipForward, Upload, X } from "lucide-react";
